export const cvData = {
  personal: {
    name: "Eoin Logue",
    title: "Data Analyst",
    email: "eoinlogue@gmail.com",
    phone: "07729431660",
    address: "57 Royal Lodge Road, Belfast BT8 7UL",
    bio: "I am a highly skilled Data Analyst with experience in the banking and energy sectors. I have a track record of leading projects to designing and developing impactful dashboards that support data-driven decision-making. Proficient at optimising data flows and developing solutions through efficient Extract, Transform, Load (ETL) processes and modern analytical techniques, with a strong focus on delivering high-quality user experiences.",
    avatar: "/Avatar.JPG"
  },
  experience: [
    {
    ...
    },
    {
      ...
      summary: "Responsible as part of the Business Improvement Team, for the development and maintenance of management reports, recommending and implementing continuous improvements to achieve key performance indicators.",
      responsibilities: [
        "Responsible for analysing, and interpreting trends including in staff productivity and customer behaviour.",
        "Liaise with the Management Team to develop better reporting mechanisms and enhance decision-making."
      ],
      achievements: [
        "Analysed existing business processes and systems, recommended and implemented automation solutions, using Visual Basic for Applications (VBA) to create efficiencies and reduce human error.",
        "Designed and implemented a new commission payment structure for sales agents, resulting in increased sales volumes and sales conversion of 8% within 3 months."
      ]
    }
  ],
  education: [
    ...
    },
    {
      ...
      result: "A-Levels: Business Studies (A), ICT (B), Govt & Politics (B). GCSEs: 2A, 7B, 1C inc. A in English Language & B in Maths.",
      period: "2010 - 2017"
    }
  ],
  skills: {
    categories: [
      {
        ...
        items: [
          { name: "Tableau (Server & Desktop)", level: 95 },
          { name: "Power BI", level: 90 },
          { name: "Grafana", level: 90 },
          { name: "Qlikview", level: 80 },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "AGILE Methodology (Jira)", level: 95 },
          { name: "Visio", level: 80 }
        ]
      },
      {
  ...
  interests: [
    "I enjoy prioritising my health and wellbeing, and setting fitness goals. I completed the Belfast Marathon in 2019. I have undertaken skydiving, legs of marathons and abseiling for charities.",
